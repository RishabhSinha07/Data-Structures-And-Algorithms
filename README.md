...
- 🔭 I’m currently working on leaning while developing!
- 🌱 I’m currently working with C++, Python, React, Flutter, Selenium, C++, Js, HTML, CSS, Electron JS, .... (We will see what else comes along the way :D)
- 👯 Working at Amazon
...
- Documenting different parts of Data Structurs and Algorithms while practicing for competative programming. 
...
## NOTE: 
- I will be following questions from leetcode for all these topics and will try to document all the problems. 
